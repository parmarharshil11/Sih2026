...
1. **Windows Environment**: The user is on Windows. Avoid PowerShell syntax errors (especially with &&). 
...
## 4. Next Steps
Please use your view_file tool to read the following files in this memory/ directory before you begin writing code:
